...
class MarchantsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.marchants.index', compact('marchants'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.marchants.create', compact('roles'));
    }
    ...
    public function store(StoreMarchantRequest $request)
    {
        ...
        return redirect()->route('frontend.marchants.index');
    }
    ...
    public function edit(Marchant $marchant)
    {
        ...
        return view('frontend.marchants.edit', compact('marchant', 'roles'));
    }
    ...
    public function show(Marchant $marchant)
    {
        ...
        return view('frontend.marchants.show', compact('marchant'));
    }
