...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    // Marchants
    Route::delete('marchants/destroy', 'MarchantsController@massDestroy')->name('marchants.massDestroy');
    Route::resource('marchants', 'MarchantsController');

    // Active Users
    Route::delete('active-users/destroy', 'ActiveUsersController@massDestroy')->name('active-users.massDestroy');
    Route::resource('active-users', 'ActiveUsersController');

    // Interfacepane
    Route::delete('interfacepanes/destroy', 'InterfacepaneController@massDestroy')->name('interfacepanes.massDestroy');
    Route::resource('interfacepanes', 'InterfacepaneController');

    // Marchant Panel
    Route::delete('marchant-panels/destroy', 'MarchantPanelController@massDestroy')->name('marchant-panels.massDestroy');
    Route::resource('marchant-panels', 'MarchantPanelController');

    // Active Agents
    Route::delete('active-agents/destroy', 'ActiveAgentsController@massDestroy')->name('active-agents.massDestroy');
    Route::resource('active-agents', 'ActiveAgentsController');
