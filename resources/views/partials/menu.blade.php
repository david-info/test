<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('user_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/permissions*") ? "c-show" : "" }} {{ request()->is("admin/roles*") ? "c-show" : "" }} {{ request()->is("admin/audit-logs*") ? "c-show" : "" }} {{ request()->is("admin/teams*") ? "c-show" : "" }}">
        ...
        @endcan
        @can('interface_panel_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/users*") ? "c-show" : "" }} {{ request()->is("admin/active-users*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-users c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.interfacePanel.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('user_access')
                        <li class="c-sidebar-nav-item">
                    ...
                    @endcan
                    @can('active_user_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.active-users.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/active-users") || request()->is("admin/active-users/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.activeUser.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @endcan
        @can('interfacepane_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.interfacepanes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/interfacepanes") || request()->is("admin/interfacepanes/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.interfacepane.title') }}
                </a>
            </li>
        @endcan
        @can('marchant_panel_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.marchant-panels.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/marchant-panels") || request()->is("admin/marchant-panels/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.marchantPanel.title') }}
                </a>
            </li>
        @endcan
        @can('agent_panel_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/agents*") ? "c-show" : "" }} {{ request()->is("admin/active-agents*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.agentPanel.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('agent_access')
                        <li class="c-sidebar-nav-item">
                    ...
                    @endcan
                    @can('active_agent_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.active-agents.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/active-agents") || request()->is("admin/active-agents/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.activeAgent.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @endcan
        @can('marchant_panelmenu_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/marchants*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.marchantPanelmenu.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('marchant_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.marchants.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/marchants") || request()->is("admin/marchants/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-user c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.marchant.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
